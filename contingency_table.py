...
#THIS SCRIPT WILL CREATE THE DATA NEEDED FOR A CONTINGENCY TABLE. IT WILL NOT CONSTRUCT THE TABLE ITSELF. CHANGE THE THRESHOLDS ACCORDING TO THE ONES RELEVANT FOR YOUR LOCATION (CAN CALCULATE WITH THE SCRIPT FIG7_DEFINE_5YRTHRESHOLD))
